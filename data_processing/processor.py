...
if __name__ == "__main__":
    ...
    parser.add_argument("--language", type=str, default="java",
                        help="language")
    parser.add_argument("--input_file", type=str, default="data_processed/java-small-test.pkl",
                        help="the input file name")
    parser.add_argument("--schema_file", type=str, default="data_processed/java-small-test_schema.pkl",
                        help="the output file name")
    parser.add_argument("--output_file", type=str, default="data_processed/java-small-test_all.pkl",
                        help="the output file name")
