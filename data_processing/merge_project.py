...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_name", type=str, default="java-med",
                        help="data name")      
    parser.add_argument("--data_path", type=str, default="java_data/java-med/",
                        help="file path")
    ...
    pickle.dump(train_data, open(args.save_path+args.data_name+'/'+args.data_name+'-train.pkl', "wb"))
    pickle.dump(eval_data, open(args.save_path+args.data_name+'/'+args.data_name+'-eval.pkl', "wb"))
    pickle.dump(test_data, open(args.save_path+args.data_name+'/'+args.data_name+'-test.pkl', "wb"))
